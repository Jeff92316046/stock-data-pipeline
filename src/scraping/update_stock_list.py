...
def update_stock_list():
    with get_driver() as driver:
        ...
        try:
            ...
            driver.find_element(XPATH,"//*[@id='form1']/table/tbody/tr[6]/td/input").click() #查詢按鈕
            stock_list = driver.find_element(XPATH,"//*[@id='body']/div/main/div[6]/div/table/tbody") #股票清單table
            ...
            for i in stock_list:
                ...
                if stock_symbol_lenght == 4:
                    upsert_stock_by_symbol(stock_symbol,stock_name) #只蒐集股票代號長度為4的股票
            ...
            driver.find_element(XPATH,"//*[@id='marketType1']/option[2]").click() # 上櫃選項
            driver.find_element(XPATH,"//*[@id='form1']/table/tbody/tr[6]/td/input").click() #查詢按鈕
            stock_list = driver.find_element(XPATH,"//*[@id='body']/div/main/div[6]/div/table/tbody") #股票清單table
            stock_list = stock_list.find_elements(XPATH,"./*") #list股票清單
            for i in stock_list:
